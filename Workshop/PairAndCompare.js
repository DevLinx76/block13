...
pairAndCompare("cat", "cat", 6, ""); // true

pairAndCompare("five", 5, "dog", "horse"); // true

pairAndCompare(0, false, "horse", "ate"); // true

pairAndCompare("eight", "eight", "ate", "four"); // true

pairAndCompare(11, "eleven", "four", "pie"); // true

pairAndCompare("cake", "cake", "pie", ""); // true
